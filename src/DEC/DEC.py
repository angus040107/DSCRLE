...
from src.DEC.datasets import load_data
import src.DEC.metrics as metrics
...
class DEC(object):
    ...
    def fit(self, x, y=None, maxiter=2e4, batch_size=256, tol=1e-3,
        ...
        return y_pred, self.encoder.predict(x)

def dec_reduction(x, y, cfg):
    import argparse
    ...
    y_pred, q = dec.fit(x, y=y, tol=args.tol, maxiter=args.maxiter, batch_size=args.batch_size,
